		...
		<div class="shell hero__inner">
			<div class="hero__statement">
				<div class="hero__heading">
					<p class="section-label">{homeCopy.hero.label}</p>
			...
			<div class="hero__visual" aria-hidden="true">
				...
				<div class="hero__visual-brand">
					<ProjectMediaPlaceholder tone="brand" />
				</div>
			</div>
		</div>
	</section>
	...
	<section class="about-section" aria-labelledby="home-about-title">
		<div class="shell about-grid">
			<div class="about-heading">
				<p class="section-label">{homeCopy.about.label}</p>
	...
	<section class="contact-section" aria-labelledby="home-contact-title">
		<div class="shell contact-grid">
			<div class="contact-heading">
				<p class="section-label">{homeCopy.contact.label}</p>
...
<style>
	...
	.hero__inner {
		...
		padding-block: clamp(5rem, 8vw, 7.5rem) clamp(4.5rem, 7vw, 6.5rem);
	}
	...
	.lead-project h3 a,
	.secondary-project h3 a {
		text-decoration: none;
	}

	.project-description,
	.secondary-project__copy {
		display: grid;
		gap: 1.2rem;
		align-content: start;
		justify-items: start;
	...
	@media (hover: hover) {
		...
		.lead-project h3 a:hover,
		.secondary-project h3 a:hover {
			text-decoration: underline;
			text-decoration-thickness: 1px;
	...
	@media (max-width: 64rem) {
		...
		.secondary-project .project-media-link {
			grid-row: 1;
		}
	}
