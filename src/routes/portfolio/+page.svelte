...
<svelte:head>
	<title>Portfolio — Hellocraft Studios</title>
	<meta name="description" content={portfolioCopy.hero.body} />
</svelte:head>
...
<main id="main-content">
	<section class="hero" aria-labelledby="portfolio-title">
		<div class="shell hero__inner">
			<div class="hero__heading">
				<p class="section-label">{portfolioCopy.hero.label}</p>
				<h1 id="portfolio-title">{portfolioCopy.hero.title}</h1>
			</div>

			<div class="hero__support">
				<p>{portfolioCopy.hero.body}</p>
	...
	<section class="projects" aria-label="Projects">
		<div class="shell">
							...
							<article class="lead-project">
								...
								<div class="lead-project__caption">
									<div class="project-heading">
										...
										{/if}
										<h2><a href={`/portfolio/${project.slug}`}>{project.title}</a></h2>
									</div>
			...
			{:else}
				<p class="pending-state">{portfolioCopy.emptyState}</p>
			{/if}
		</div>
	</section>
</main>
